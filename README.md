...
This repository contains the official implementation of the paper **"[FoundPAD: Foundation Models Reloaded for Face Presentation Attack Detection](link-to-paper),"** accepted to **WACV2025 AI4MFDD** (*2nd Workshop on Artificial Intelligence for Multimedia Forensics and Disinformation Detection*).
